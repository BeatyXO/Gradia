...
class GradiaAssessment(gl.Contract):
    ...
    def _run_consensus_grading(self, assessment: typing.Any, submission: typing.Any) -> typing.Any:
        ...
        context = f"ASSESSMENT: {assessment_json}\nSUBMISSION: {submission_json}"

        # non_comparative: leader grades the submission, validators judge whether
        # the grade is a reasonable, rubric-grounded reading of the public evidence.
        consensus_json = gl.eq_principle.prompt_non_comparative(
            ...
            task=(
                ...
                '{"finalGrade":"B+","confidence":80,"rubricAlignment":"High",'
            ...
            criteria=(
                ...
                "The grade must be justified by the public evidence URL and hash provided, not assumed.\n"
    ...
    def request_assessment_consensus(self, assessment_id: str, submission_id: str) -> str:
        ...
        key = self._key2(assessment_id, submission_id)
        self.consensus_records[key] = self._json(result)
    ...
    def get_consensus_record(self, assessment_id: str, submission_id: str) -> str:
        return self.consensus_records.get(self._key2(assessment_id, submission_id), "")
